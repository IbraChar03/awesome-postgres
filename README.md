...
* [MergeBrake](https://github.com/mergebrake/mergebrake) - Pre-merge schema-impact guard for Postgres + Prisma/Drizzle that maps `DROP COLUMN` to the application code it would break, with AI-PR scrutiny for     migrations generated by Claude/Cursor/Codex.
